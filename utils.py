...
Node = namedtuple('Node', ['id', 'node1', 'node2', 'name'])
...
def prepare_dirs(args):
    ...
    if args.model_name and not args.load_path:
    ...
    elif args.model_name and args.load_path:
        args.model_dir =  "logs/{}_{}".format(args.dataset, args.model_name)
    else:
        if args.load_path:
